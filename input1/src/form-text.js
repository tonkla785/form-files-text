  ...
  return (
    ...
    >
      <form>
        ...
        <div className="form-group mb-2">
          <label htmlFor="pswd2">ใส่รหัสผ่านซํ้า</label>
          <input
            type="password"
            id="pswd2"
            className="form-control form-control-sm"
        ...
        <div className="form-group mb-4">
          <label htmlFor="memo">บันทึกช่วยจํา</label>
          <textarea
            id="memo"
            name="memo"
            rows="2"
        ...
        <div className="text-center">
          <button className="btn btn-sm btn-primary px-4 mb-4">OK</button>
        </div>
      </form>
    </div>
  );
